...
<Steps>
  <Step title="导入AI Copilot的基础BPMN">
    你可以在[这里下载](https://oriorion.com/assets/reference/aicopilot_basic.bpmn)到这个基础BPMN定义。这个流程的定义ID为“`Process_bpezAICopilot_Test`”，请不要更改它。你可以在设计模块中上传这个文件进行后续的参数设置、部署管理。
  </Step>
